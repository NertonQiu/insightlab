...
public interface ModelingService {
	...
	JSONObject createModelCounts(JSONObject params)
			throws BaseDataApiException, JSONException;

	JSONObject getModelCounts(JSONObject params) throws BaseDataApiException,
			JSONException;

	JSONObject createSegment(String segment) throws JSONException,
			BaseDataApiException;

	JSONObject updateSegment(String segment) throws JSONException,
			BaseDataApiException;
}