...
public class BarMiddleSizeChartCustomizer extends JRAbstractChartCustomizer {

	private static final double MAXIMUM_BAR_WIDTH = 0.0213;
	private static final double ITEM_MARGIN = 0.013;
