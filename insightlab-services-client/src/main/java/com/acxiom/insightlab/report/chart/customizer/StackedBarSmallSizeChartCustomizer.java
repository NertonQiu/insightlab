...
public class StackedBarSmallSizeChartCustomizer extends JRAbstractChartCustomizer {

	private static final int CATEGORY_AXIS_OFFSET = -1;
	private static final int FONT_SIZE = 8;

	private static final double MAXIMUM_BAR_WIDTH = 0.091;
	private static final double ITEM_MARGIN = 0.010;
