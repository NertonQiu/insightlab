 ...
 * @module geo-chart
 **/
ACX.add('geo-chart', function(A) {
  /**
   * GeoChart
   * @constructor
   * @param {Node|Element} container_id
   */
  function GeoChart(container_id) {

    /**
     * Defaults chat options.
     */
    var DEFAULT_OPTIONS = {
      viewOptions: { coordinates: [37.8, -96], size: 3.7 }
    };

    this.initChart = function(config) {
      config_ = config;
      if (!container_id) return false;
      map = L.map(container_id).setView(DEFAULT_OPTIONS['viewOptions']['coordinates'], DEFAULT_OPTIONS['viewOptions']['size']);
    ...
    /**
     * Initialization of informational tooltip.
     * @private
     */
    var initInfo = function() {
      if (!config_['info']) return;
      info = L.control();
      ...
      info.update = function(props) {
        if (props) {
          this._div.innerHTML = ((props.density != -1) ?
            '<b>' + props.name + '</b><br />' + props.density.toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',').replace('.00', '') + '</sup>' :
            '<b>' + props.name + '</b>');
        } else {
    ...
    function zoomToFeature(e) {
      ...
      var dmaMap = getDMAByStateName(e.target.feature.properties.name);
      L.geoJson(dmaMap['data'], {
        style: dmaMap['style'],
    ...
    /**
     * Draws the geochart component.
     * @this {GeoChart}
     */
    this.draw = function() {
      for (var index = 0; index < maps_.length; index++) {
        geojson = L.geoJson(maps_[index]['data'], {
          style: customStyle, // maps_[index]["style"],
          onEachFeature: onEachFeature
        }).addTo(map);
      }
    };
    ...
    //TODO create method which returns dma regions by state name
    var getDMAByStateName = function(name) {
      var customRegion = counties;
      var customRegionStyle = {
        'color': '#1f2345',
        'weight': 2,
        'opacity': 0.8
      };

      return { data: customRegion, style: style };

    };

    /* contains array of data for creating maps
     * @type {Array}
     * @private
     */
    var maps_ = [];

    //TODO modify method for using custom legend
    var initLegend = function() {
      if (!config_['legend']) return;
...
function GeoMapper(data) {
  var geo = { 'type': 'FeatureCollection', 'features': [
    { 'type': 'Feature', 'id': '01', 'properties': { 'name': 'Alabama', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-87.359296, 35.00118],
        [-85.606675, 34.984749],
        [-85.431413, 34.124869],
    ...
    { 'type': 'Feature', 'id': '02', 'properties': { 'name': 'Alaska', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
    ...
    { 'type': 'Feature', 'id': '04', 'properties': { 'name': 'Arizona', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '05', 'properties': { 'name': 'Arkansas', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-94.473842, 36.501861],
        [-90.152536, 36.496384],
        [-90.064905, 36.304691],
    ...
    { 'type': 'Feature', 'id': '06', 'properties': { 'name': 'California', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '08', 'properties': { 'name': 'Colorado', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '09', 'properties': { 'name': 'Connecticut', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-73.053528, 42.039048],
        [-71.799309, 42.022617],
        [-71.799309, 42.006186],
    ...
    { 'type': 'Feature', 'id': '10', 'properties': { 'name': 'Delaware', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-75.414089, 39.804456],
        [-75.507197, 39.683964],
        [-75.611259, 39.61824],
    ...
    { 'type': 'Feature', 'id': '11', 'properties': { 'name': 'District of Columbia', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-77.035264, 38.993869],
        [-76.909294, 38.895284],
        [-77.040741, 38.791222],
    ...
    { 'type': 'Feature', 'id': '12', 'properties': { 'name': 'Florida', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-85.497137, 30.997536],
        [-85.004212, 31.003013],
        [-84.867289, 30.712735],
    ...
    { 'type': 'Feature', 'id': '13', 'properties': { 'name': 'Georgia', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-83.109191, 35.00118],
        [-83.322791, 34.787579],
        [-83.339222, 34.683517],
    ...
    { 'type': 'Feature', 'id': '15', 'properties': { 'name': 'Hawaii', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
    ...
    { 'type': 'Feature', 'id': '16', 'properties': { 'name': 'Idaho', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-116.04751, 49.000239],
        [-116.04751, 47.976051],
    ...
    { 'type': 'Feature', 'id': '17', 'properties': { 'name': 'Illinois', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-90.639984, 42.510065],
        [-88.788778, 42.493634],
        [-87.802929, 42.493634],
    ...
    { 'type': 'Feature', 'id': '18', 'properties': { 'name': 'Indiana', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-85.990061, 41.759724],
        [-84.807042, 41.759724],
        [-84.807042, 41.694001],
    ...
    { 'type': 'Feature', 'id': '19', 'properties': { 'name': 'Iowa', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-91.368417, 43.501391],
        [-91.215062, 43.501391],
        [-91.204109, 43.353514],
    ...
    { 'type': 'Feature', 'id': '20', 'properties': { 'name': 'Kansas', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-101.90605, 40.001626],
        [-95.306337, 40.001626],
        [-95.207752, 39.908518],
    ...
    { 'type': 'Feature', 'id': '21', 'properties': { 'name': 'Kentucky', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-83.903347, 38.769315],
        [-83.678792, 38.632391],
        [-83.519961, 38.703591],
    ...
    { 'type': 'Feature', 'id': '22', 'properties': { 'name': 'Louisiana', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-93.608485, 33.018527],
        [-91.16577, 33.002096],
        [-91.072662, 32.887081],
    ...
    { 'type': 'Feature', 'id': '23', 'properties': { 'name': 'Maine', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-70.703921, 43.057759],
        [-70.824413, 43.128959],
        [-70.807983, 43.227544],
    ...
    { 'type': 'Feature', 'id': '24', 'properties': { 'name': 'Maryland', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
          [-75.994645, 37.95325],
          [-76.016553, 37.95325],
    ...
    { 'type': 'Feature', 'id': '25', 'properties': { 'name': 'Massachusetts', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-70.917521, 42.887974],
        [-70.818936, 42.871543],
        [-70.780598, 42.696281],
    ...
    { 'type': 'Feature', 'id': '26', 'properties': { 'name': 'Michigan', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
          [-83.454238, 41.732339],
          [-84.807042, 41.694001],
    ...
    { 'type': 'Feature', 'id': '27', 'properties': { 'name': 'Minnesota', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-92.014696, 46.705401],
        [-92.091373, 46.749217],
        [-92.29402, 46.667063],
    ...
    { 'type': 'Feature', 'id': '28', 'properties': { 'name': 'Mississippi', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-88.471115, 34.995703],
        [-88.202745, 34.995703],
        [-88.098683, 34.891641],
    ...
    { 'type': 'Feature', 'id': '29', 'properties': { 'name': 'Missouri', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-91.833957, 40.609566],
        [-91.729895, 40.615043],
        [-91.527248, 40.412397],
    ...
    { 'type': 'Feature', 'id': '30', 'properties': { 'name': 'Montana', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '31', 'properties': { 'name': 'Nebraska', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '32', 'properties': { 'name': 'Nevada', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-117.027882, 42.000709],
        [-114.04295, 41.995232],
        [-114.048427, 37.000263],
    ...
    { 'type': 'Feature', 'id': '33', 'properties': { 'name': 'New Hampshire', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-71.08183, 45.303304],
        [-71.032537, 44.657025],
        [-70.966814, 43.34256],
    ...
    { 'type': 'Feature', 'id': '34', 'properties': { 'name': 'New Jersey', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-74.236547, 41.14083],
        [-73.902454, 40.998429],
        [-74.022947, 40.708151],
    ...
    { 'type': 'Feature', 'id': '35', 'properties': { 'name': 'New Mexico', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-107.421329, 37.000263],
        [-106.868158, 36.994786],
        [-104.337812, 36.994786],
    ...
    { 'type': 'Feature', 'id': '36', 'properties': { 'name': 'New York', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-73.343806, 45.013027],
        [-73.332852, 44.804903],
        [-73.387622, 44.618687],
    ...
    { 'type': 'Feature', 'id': '37', 'properties': { 'name': 'North Carolina', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-80.978661, 36.562108],
        [-80.294043, 36.545677],
        [-79.510841, 36.5402],
    ...
    { 'type': 'Feature', 'id': '38', 'properties': { 'name': 'North Dakota', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-97.228743, 49.000239],
        [-97.097296, 48.682577],
        [-97.16302, 48.545653],
    ...
    { 'type': 'Feature', 'id': '39', 'properties': { 'name': 'Ohio', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-80.518598, 41.978802],
        [-80.518598, 40.636951],
        [-80.666475, 40.582182],
    ...
    { 'type': 'Feature', 'id': '40', 'properties': { 'name': 'Oklahoma', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-100.087706, 37.000263],
        [-94.616242, 37.000263],
        [-94.616242, 36.501861],
    ...
    { 'type': 'Feature', 'id': '41', 'properties': { 'name': 'Oregon', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
    ...
    { 'type': 'Feature', 'id': '42', 'properties': { 'name': 'Pennsylvania', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-79.76278, 42.252649],
        [-79.76278, 42.000709],
        [-75.35932, 42.000709],
    ...
    { 'type': 'Feature', 'id': '44', 'properties': { 'name': 'Rhode Island', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
          [-71.196845, 41.67757],
          [-71.120168, 41.496831],
    ...
    { 'type': 'Feature', 'id': '45', 'properties': { 'name': 'South Carolina', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-82.764143, 35.066903],
        [-82.550543, 35.160011],
        [-82.276696, 35.198349],
    ...
    { 'type': 'Feature', 'id': '46', 'properties': { 'name': 'South Dakota', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-104.047534, 45.944106],
        [-96.560556, 45.933153],
        [-96.582464, 45.818137],
    ...
    { 'type': 'Feature', 'id': '47', 'properties': { 'name': 'Tennessee', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-88.054868, 36.496384],
        [-88.071299, 36.677123],
        [-87.852221, 36.633308],
    ...
    { 'type': 'Feature', 'id': '48', 'properties': { 'name': 'Texas', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-101.812942, 36.501861],
        [-100.000075, 36.501861],
        [-100.000075, 34.563024],
    ...
    { 'type': 'Feature', 'id': '49', 'properties': { 'name': 'Utah', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-112.164359, 41.995232],
        [-111.047063, 42.000709],
    ...
    { 'type': 'Feature', 'id': '50', 'properties': { 'name': 'Vermont', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-71.503554, 45.013027],
        [-71.4926, 44.914442],
        [-71.629524, 44.750133],
    ...
    { 'type': 'Feature', 'id': '51', 'properties': { 'name': 'Virginia', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
          [-75.397659, 38.013497],
          [-75.244304, 38.029928],
    ...
    { 'type': 'Feature', 'id': '53', 'properties': { 'name': 'Washington', 'density': -1 }, 'geometry': { 'type': 'MultiPolygon', 'coordinates': [
      [
        [
          [-117.033359, 49.000239],
          [-117.044313, 47.762451],
    ...
    { 'type': 'Feature', 'id': '54', 'properties': { 'name': 'West Virginia', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-80.518598, 40.636951],
        [-80.518598, 39.722302],
        [-79.477979, 39.722302],
    ...
    { 'type': 'Feature', 'id': '55', 'properties': { 'name': 'Wisconsin', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-90.415429, 46.568478],
        [-90.229213, 46.508231],
        [-90.119674, 46.338446],
    ...
    { 'type': 'Feature', 'id': '56', 'properties': { 'name': 'Wyoming', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-109.080842, 45.002073],
        [-105.91517, 45.002073],
        [-104.058488, 44.996596],
    ...
    { 'type': 'Feature', 'id': '72', 'properties': { 'name': 'Puerto Rico', 'density': -1 }, 'geometry': { 'type': 'Polygon', 'coordinates': [
      [
        [-66.448338, 17.984326],
        [-66.771478, 18.006234],
        [-66.924832, 17.929556],
  ...
  var row = data['rows'];
  var dataGeo = geo['features'];
  for (var i = 0; i < row.length; i++) {
    var s = row[i][0];
    for (var h = 0; h < dataGeo.length; h++) {
      if (s == dataGeo[h]['properties'].name) {
        dataGeo[h]['properties']['density'] = row[i][1];
      }
    }
  }
