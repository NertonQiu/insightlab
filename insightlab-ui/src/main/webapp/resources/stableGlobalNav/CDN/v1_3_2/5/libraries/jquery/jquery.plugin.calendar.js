 ...
 */
 ;(function() {
	$.fn.calendar = function(options) {
		...
		if(!instance) {
			...
			return this.each(function() {
				return $(this).data(pluginName, new calendar(this, options));
			});
		}
	...
	var calendar = (function() {
		...
		function calendar(element, userOptions) {
			// Grab handle to this
			var self = this;
			...
			self.options = $.extend(true, {}, $.fn.calendar.defaults, userOptions);
		...
		calendar.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var selectableYears = getSelectableList(1900, todayVal.year + 20, options.selectableYears);
