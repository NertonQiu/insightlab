$.fn.extend({
  spinit: function(options) {
    var settings = $.extend({ min: 0, max: 100, initValue: 0, callback: null, stepInc: 1, pageInc: 10, width: 45, height: 26, btnWidth: 10, mask: '' }, options);
    return this.each(function() {
      ...
      var el = $(this).val(value).css('width', (settings.width) + 'px').css('height', settings.height + 'px').css('line-height', settings.height + 'px').addClass('acxiom-spinner');
      raiseCallback(value);
